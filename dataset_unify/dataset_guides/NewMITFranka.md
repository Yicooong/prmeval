...
Configuration file: `dataset_unify/configs/data_gen_configs/new_mit_franka.yaml`
...
```bash
uv run python -m dataset_unify.generate_hf_dataset --config_path=dataset_unify/configs/data_gen_configs/new_mit_franka.yaml
```

To only process external camera views (exclude wrist camera):

```bash
uv run python -m dataset_unify.generate_hf_dataset --config_path=dataset_unify/configs/data_gen_configs/new_mit_franka.yaml --dataset.exclude_wrist_cam=true
```
