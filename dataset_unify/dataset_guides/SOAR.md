...
pip install -r dataset_unify/dataset_helpers/soar_vlm_labeling_reqs.txt
...
```bash
python dataset_unify/dataset_helpers/generate_soar_labels_vlm.py \
    --dataset_path /path/to/soar/rlds \
    --output dataset_unify/dataset_helpers/soar_vlm_labels.json
```
...
python dataset_unify/dataset_helpers/generate_soar_labels_vlm.py \
    --dataset_path /path/to/soar/rlds \
    --output dataset_unify/dataset_helpers/soar_vlm_labels_8b.json \
...
python dataset_unify/dataset_helpers/generate_soar_labels_vlm.py \
    --dataset_path /path/to/soar/rlds \
    --output dataset_unify/dataset_helpers/test_labels.json \
    --max_episodes 10
```
...
python dataset_unify/dataset_helpers/generate_soar_labels_vlm.py \
    --dataset_path /path/to/soar/rlds \
    --output dataset_unify/dataset_helpers/soar_labels_8b.json \
...
```bash
uv run python -m dataset_unify.generate_hf_dataset --config_path=dataset_unify/configs/data_gen_configs/soar.yaml
```
