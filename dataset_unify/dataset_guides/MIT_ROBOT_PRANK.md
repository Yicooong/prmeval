...
Configuration file: `dataset_unify/configs/data_gen_configs/mit_robot_prank.yaml`
...
```bash
uv run python -m dataset_unify.generate_hf_dataset --config_path=dataset_unify/configs/data_gen_configs/mit_franka_prank.yaml
```
