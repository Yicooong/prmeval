...
bash dataset_unify/data_scripts/usc_koch_human_robot_paired/download_datasets.sh

# 2. Convert human demonstrations
uv run python -m dataset_unify.generate_hf_dataset \
    --config_path=dataset_unify/configs/data_gen_configs/usc_koch_human_robot_paired.yaml \
