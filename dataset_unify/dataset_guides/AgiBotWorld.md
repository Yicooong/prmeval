...
```
 uv run dataset_unify/data_scripts/agibot/download_task_jsons.py 
 ```
...
```bash
uv run python dataset_unify/generate_hf_dataset.py --config_path=dataset_unify/configs/data_gen_configs/agibot_world.yaml
```
