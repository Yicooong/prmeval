...
File: `dataset_unify/configs/data_gen_configs/utd_so101_clean_policy_ranking_wrist.yaml`
...
File: `dataset_unify/configs/data_gen_configs/utd_so101_clean_policy_ranking_top.yaml`
...
```bash
uv run python -m dataset_unify.generate_hf_dataset \
    --config_path=dataset_unify/configs/data_gen_configs/utd_so101_clean_policy_ranking_wrist.yaml
```
...
```bash
uv run python -m dataset_unify.generate_hf_dataset \
    --config_path=dataset_unify/configs/data_gen_configs/utd_so101_clean_policy_ranking_top.yaml
```
