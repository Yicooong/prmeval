...
```bash
uv run python dataset_unify/generate_hf_dataset.py \
    --config_path=dataset_unify/configs/data_gen_configs/libero.yaml\
...
```bash
uv run bash dataset_unify/data_scripts/libero/gen_all_libero.sh
```
