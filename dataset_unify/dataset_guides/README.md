...
| **Simulator Rollout** | Simulation | Local | Frame-aligned simulator progress | [📖 SimulatorRollout.md](SimulatorRollout.md) |
...
```bash
uv run python dataset_unify/generate_hf_dataset.py --config_path=dataset_unify/configs/data_gen_configs/fino_net.yaml
```
