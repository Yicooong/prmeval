...
```bash
bash dataset_unify/data_scripts/humanoid_everyday/download_humanoid_everyday.sh
```
...
```bash
uv run python -m dataset_unify.generate_hf_dataset --config dataset_unify/configs/data_gen_configs/humanoid_everyday.yaml
```
